...
KC_TRNS,            KC_UNDO,              KC_CUT,               KC_COPY,            KC_PASTE,            KC_FIND,             KC_TRNS,             KC_TRNS,             KC_PSCR,             KC_END,             KC_NO,                KC_NO,              KC_NO,               KC_NO,
                    KC_TRNS,              KC_TRNS,              KC_TRNS,            KC_TRNS,             KC_TRNS,                                                       KC_TRNS,             KC_TRNS,            KC_TRNS,              KC_TRNS,            KC_TRNS
),
[_ADJUST] = LAYOUT(
QK_REBOOT,          KC_NO,                KC_NO,                KC_NO,              KC_NO,               KC_NO,                                                         KC_NO,               KC_NO,              KC_NO,                KC_NO,              KC_NO,               KC_NO,
KC_NO,              KC_INS,               KC_SCRL,              BL_TOGG,            RGB_TOG,             CG_SWAP,                                                       KC_BRIU,             KC_VOLD,            KC_NO,                KC_VOLU,            KC_NO,               KC_NO,
KC_CAPS,            RGB_HUI,              RGB_SAI,              RGB_VAI,            RGB_MOD,             KC_NO,                                                         KC_BRID,             KC_MPRV,            KC_MPLY,              KC_MNXT,            KC_NO,               KC_NO,
KC_NO,              RGB_HUD,              RGB_SAD,              RGB_VAD,            RGB_RMOD,            KC_NO,               KC_TRNS,             KC_TRNS,             KC_NO,               KC_NO,              KC_NO,                KC_NO,              KC_NO,               KC_NO,
                    KC_TRNS,              KC_TRNS,              KC_TRNS,            KC_TRNS,             KC_TRNS,                                                       KC_TRNS,             KC_TRNS,            KC_TRNS,              KC_TRNS,            KC_TRNS
)
//                  |                    |                    |                    |                    |                    |                    |                    |                    |                    |                    |                    |                    |
};
